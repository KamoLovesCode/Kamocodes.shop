...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className }) => (
	...
	c-5.222,0-9.657-3.344-11.303-7.962l-6.573,4.817C9.656,39.663,16.318,44,24,44z"/>
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.089,5.571
	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C39.712,35.619,44,30.138,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
    </svg>
);
